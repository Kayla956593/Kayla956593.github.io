			...
			for(var x in mapArray){
				for(var y in mapArray[x]){
					if(mapArray[x][y]==1){
						...
						ctx.drawImage(imgMountain,32,32,32,32,y*gridLength,x*gridLength,gridLength,gridLength*2);
					}
					else if(mapArray[x][y]==5){
						
							ctx.drawImage(imgMountain,130,90,30,45,y*gridLength,x*gridLength,gridLength,gridLength); 
...
$(document).on("keydown",function(event){
	...
	else{targetBlock.x=-1;targetBlock.y=-1;}
	//清空主角原本所在的位置
